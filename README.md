...
> **Maintained by [Shai Shotashvili](https://github.com/Shaus12) - FutureProof AI.**
> This is my distribution of **scroll-craft**, originally created by
> [Nate Herk](https://github.com/nateherkai) and released under the MIT licence.
> Same engine and same design standard, packaged as the `futureproof` marketplace so
> it installs in one line. Original credit stays where it belongs - see
...
[![Agent skill](https://img.shields.io/badge/agent-skill-3b82f6.svg)](plugins/futureproof-design/skills/scroll-craft/SKILL.md)
...
Read the [worked examples and production workflow](plugins/futureproof-design/skills/scroll-craft/references/approved-collection.md)
and the [hero-depth guide](plugins/futureproof-design/skills/scroll-craft/references/hero-depth.md).
...
[`plugins/futureproof-design/skills/scroll-craft/`](plugins/futureproof-design/skills/scroll-craft/).
...
```text
Read plugins/futureproof-design/skills/scroll-craft/SKILL.md and use it to build
...
```bash
/plugin marketplace add Shaus12/scroll-craft
```
```bash
/plugin install futureproof-design@futureproof
```
...
```bash
claude --plugin-dir ./plugins/futureproof-design
```
...
```bash
node plugins/futureproof-design/skills/scroll-craft/scripts/doctor.mjs
node plugins/futureproof-design/skills/scroll-craft/scripts/workspace.mjs --ensure
```
...
[`CHANGELOG.md`](plugins/futureproof-design/skills/scroll-craft/CHANGELOG.md) is worth reading on its own: it records what broke on each build and the rule that came out of it, rather than a feature list.
